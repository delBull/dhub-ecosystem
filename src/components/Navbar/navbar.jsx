...
const NavbarHome = ({ lr, nr, theme }) => {
  ...
  useEffect(() => {
    ...
    // dispatch(referalEarningsFn(refId))
    if (refId) {
      handleShow();
    }
  }, []);
  ...
  return (
    <div className="navbar_upperHome showNav" id="navbar_upper">
      <nav
        ref={nr}
      ...
      >
        ...
        <div className="nav_dropdown_contentMobile">
          ...
          <div className="changeLangButton hidePc">
      ...
      <CardAddModal
        ...
        // handleShowCard={() => setShow(true)}
        // handleCloseCard={() => setShow(false)}
      /> */}
    </div>
  );
};
